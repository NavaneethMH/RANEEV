...
export const navByRole = {
  ...
  admin: [
    ["Admin dashboard", "/admin"], ["User management", "/admin/users"], ["Volunteer verification", "/admin/verification"], ["Incident management", "/admin/incidents"], ["Audit logs", "/admin/audit"], ["AI activity", "/admin/ai"], ["Notification activity", "/admin/notifications"],
  ],
} as const;
